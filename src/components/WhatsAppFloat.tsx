import { DEFAULT_WHATSAPP_PHONE } from "@/lib/whatsapp-contact.helpers";

export function WhatsAppFloat({
  phone = DEFAULT_WHATSAPP_PHONE,
  message = "Hi! I just signed up for Physique 57 Open Barre. Can you help me with my first class?",
}: {
  phone?: string;
  message?: string;
}) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 group flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5b] text-white rounded-full shadow-2xl pl-3 pr-4 py-3 transition-transform hover:scale-105"
    >
