  ...
  head: () => ({
    meta: [
      { title: "About - Physique 57 India" },
      {
        name: "description",
        content:
          "The story of Physique 57 India - the legendary 57-minute barre method now in Mumbai and Bengaluru.",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-[55vh] min-h-[420px] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 h-full flex items-end pb-14 text-white">
          <div>
            <p className="text-[11px] uppercase tracking-[0.35em] text-primary font-bold mb-4">
              Our Story
            </p>
            <h1 className="font-display text-5xl md:text-7xl leading-[0.95]">
              A 57‑minute revolution
              <br />
              <em className="italic text-primary">made in NYC,</em> lived in{" "}
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 space-y-6 text-lg leading-relaxed">
        <p>
          Physique 57 is a boutique barre fitness brand founded in New York City in 2006 by Jennifer
          Vaughan Maanavi and Tanya Becker, reinventing the legendary Lotte Berk Method for a new
          generation. The studio debuted at 24 W. 57th Street in Manhattan - which is how the brand
          got its name.
        </p>
        <p>
          {isBengaluru
        ...
        <p>
          Physique 57 India was recognised in the Vogue Beauty Awards as one of the "6 Best Brands
          in the Beauty Business" in 2022, and has been featured across Vogue India, Architectural
          Digest, GQ India, and Grazia. Our philosophy is simple: workout because you love your
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20 space-y-5 text-base leading-relaxed text-muted-foreground">
        ...
        <p>
          ...
          full-body workout, short enough to fit a real schedule. There's no jumping or high-impact
          movement, so it's easy on your joints, while isometric holds and resistance still work
          muscles deeply for a genuinely high-intensity effect - no dance or barre background
          required, ever.
        </p>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-4 leading-relaxed">
              Most clients notice visible changes within 8 classes - and while Physique 57 is widely
              popular among women, the method is built for "Every BODY." Group classes add a proven
              edge too: the Kohler Effect means performance improves when we work alongside others
